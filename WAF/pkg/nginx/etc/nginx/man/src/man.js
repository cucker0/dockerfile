...
function autoHeight(ifid){
	var iframeid=document.getElementById(ifid); //iframe id
...
$(document).ready(function(){
	...
	$("#select1").change(function () {
		...
		if (str == "0") {
			...
			$("#d1,#d12,#d2,#d3,#d4,#d5,#d52,#d6").attr("style","display:none;");
		}
		else if (str == "1") {
			$("#d1").attr("style","display:block;");
			$("#d0,#d12,#d2,#d3,#d4,#d5,#d52,#d6").attr("style","display:none;");
		}
		else if (str == "12") {
			$("#d12").attr("style","display:block;");
			$("#d0,#d1,#d2,#d3,#d4,#d5,#d52,#d6").attr("style","display:none;");
		}
		else if (str == "2") {
			$("#d2").attr("style","display:block;");
			$("#d0,#d1,#d12,#d3,#d4,#d5,#d52,#d6").attr("style","display:none;");
		}
		else if (str == "3") {
			$("#d3").attr("style","display:block;");
			$("#d0,#d1,#d12,#d2,#d4,#d5,#d52,#d6").attr("style","display:none;");
		}
		else if (str == "4") {
			$("#d4").attr("style","display:block;");
			$("#d0,#d1,#d12,#d2,#d3,#d5,#d52,#d6").attr("style","display:none;");
		}
		else if (str == "5") {
			$("#d5").attr("style","display:block;");
			$("#d0,#d1,#d12,#d2,#d3,#d4,#d52,#d6").attr("style","display:none;");
		}
		else if (str == "52") {
			$("#d52").attr("style","display:block;");
			$("#d0,#d1,#d12,#d2,#d3,#d4,#d5,#d6").attr("style","display:none;");
		}
		else if (str == "6") {
			$("#d6").attr("style","display:block;");
			$("#d0,#d1,#d12,#d2,#d3,#d4,#d5,#d52").attr("style","display:none;");
		}
	});
